...
mixin _$Issue {
 ...
 String get id; String get title; String get description; String get status; int get priority; String get issueType; String get owner; DateTime get createdAt; String get createdBy; DateTime get updatedAt; List<String> get dependencies; int get dependencyCount; int get commentCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,status,priority,issueType,owner,createdAt,createdBy,updatedAt,const DeepCollectionEquality().hash(dependencies),dependencyCount,commentCount);

@override
String toString() {
  return 'Issue(id: $id, title: $title, description: $description, status: $status, priority: $priority, issueType: $issueType, owner: $owner, createdAt: $createdAt, createdBy: $createdBy, updatedAt: $updatedAt, dependencies: $dependencies, dependencyCount: $dependencyCount, commentCount: $commentCount)';
}
...
@useResult
$Res call({
 String id, String title, String description, String status, int priority, String issueType, String owner, DateTime createdAt, String createdBy, DateTime updatedAt, List<String> dependencies, int dependencyCount, int commentCount
});
...
class _Issue implements Issue {
  const _Issue({required this.id, required this.title, this.description = '', this.status = 'open', this.priority = 2, this.issueType = 'task', this.owner = '', required this.createdAt, this.createdBy = '', required this.updatedAt, final  List<String> dependencies = const [], this.dependencyCount = 0, this.commentCount = 0}): _dependencies = dependencies;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,status,priority,issueType,owner,createdAt,createdBy,updatedAt,const DeepCollectionEquality().hash(_dependencies),dependencyCount,commentCount);
